      ...
      <div className="mt-6 flex items-start gap-3 rounded-lg border border-violet-200 bg-violet-50 px-4 py-3">
        ...
        <div>
          <p className="text-xs leading-relaxed text-violet-800">
            ...
            When a transcript is uploaded against a completed survey, the
            system uses an LLM call to extract KPIs (e.g. NPS scores for
            customer surveys). Extracted values update the Dashboard averages
