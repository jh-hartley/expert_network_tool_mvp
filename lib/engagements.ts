/* ------------------------------------------------------------------ */
/*  Consensus -- Call & AI Survey engagement records                     */
/*                                                                     */
...
const CALLS_KEY = "consensus_calls"
const CALLS_SEEDED = "consensus_calls_seeded_v6"
const SURVEYS_KEY = "consensus_surveys"
const SURVEYS_SEEDED = "consensus_surveys_seeded_v5"
...
export const SEED_CALLS: EngagementRecord[] = [
  {
    ...
    is_follow_up: false,
    nps: 8,
    notes: "Very insightful on Zephyr adoption drivers. Follow up on lead times.",
  ...
  },
  {
    ...
    expert_role: "Former SVP Sales, Kestrel Automation North America",
    ...
    network: "AlphaView",
    is_follow_up: false,
    notes: "Strong views on Zephyr's competitive positioning vs Kestrel.",
  ...
  },
  {
    ...
    expert_company: "Zephyr Controls",
    expert_role: "Former COO, Zephyr Controls",
  ...
  },
  {
    ...
    expert_company: "Trilon Industrial",
    expert_role: "Head of Strategy, Trilon Industrial, Americas",
  ...
  },
  {
    ...
    is_follow_up: false,
    nps: 7,
    notes: "Excellent perspective on Zephyr vs Stonemill evaluation process.",
...
export const SEED_SURVEYS: EngagementRecord[] = [
  {
    ...
    call_time: "09:00",
    duration_minutes: 0,
    network_prices: { AlphaView: 300, GLS: null, "FifthBridge": null },
    network: "AlphaView",
    is_follow_up: false,
  ...
  },
  {
    ...
    call_time: "10:00",
    duration_minutes: 0,
    network_prices: { AlphaView: 300, GLS: 300, "FifthBridge": null },
    network: "AlphaView",
    is_follow_up: false,
    notes: "NPS 9. Very positive on Zephyr service model.",
  ...
  },
  {
    ...
    call_time: "14:00",
    duration_minutes: 0,
    network_prices: { AlphaView: null, GLS: null, "FifthBridge": 300 },
    network: "FifthBridge",
    is_follow_up: false,
    notes: "",
  ...
  },
  {
    ...
    call_time: "11:00",
    duration_minutes: 0,
    network_prices: { AlphaView: null, GLS: 300, "FifthBridge": 300 },
    network: "FifthBridge",
    is_follow_up: false,
